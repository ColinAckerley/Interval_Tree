package structures;
/**
 * Encapsulates an interval whose end points are integers. Each interval can
 * contain an additional string that provides information about that interval
 * that may be useful for an application.
 * 
 * @author runb-cs112
 */
public class Interval
{
	...
	public String desc;
	/**
	 * Initializes a new Interval object with end points and description. The
	 * left end point must be less than the right end point.
	 * 
	 * @param leftEndPoint
	 ...
	 *            Left end point of the interval
	 * @param desc
	 *            Application-specific description of this interval.
	 */
	 ...
	 * 
	 * @param point
	 *            Point that is queried for containment in interval
	 ...
	 * 
	 * @param other
	 *            The other interval with which intersection is examined
	 * @return True if this interval overlaps with the other, false is there is
	 *         no overlap
	 */
